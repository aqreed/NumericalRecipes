program test_tptest
   ! COMPILATION:
   ! gfortran -c avevar.f90 betacf.f90 gammaln.f90 betai.f90 tptest.f90 test_tptest.f90
   ! gfortran avevar.o betacf.o gammaln.o betai.o tptest.o test_tptest.0 -o ftest_tptest
   use mod_tptest
   implicit none
