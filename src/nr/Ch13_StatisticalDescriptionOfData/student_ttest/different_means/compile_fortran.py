...
if not path.isfile('fmain_ttest') or not path.isfile('fspeed_ttest'):
    # compile
    system('gfortran -c ttest.f90')
    system('gfortran -c ttest_speedTest.f90')
    # link
    system('gfortran betai.o betacf.o gammaln.o avevar.o ttest.o -o fmain_ttest')
    system('gfortran betai.o betacf.o gammaln.o avevar.o ttest_speedTest.o -o fspeed_ttest')
