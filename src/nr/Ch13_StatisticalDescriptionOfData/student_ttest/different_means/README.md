...
| |Python|Julia|
|-|------|-----|
|Fortran| ~24.6 times slower| ~1.5 times faster|
|C| TBD| TBD|
|C++| TBD| TBD|

_Note:_ this must be read as _"in a Python script, using a Python function is 24.6 times slower than calling Fortran executable code from the same script"_
